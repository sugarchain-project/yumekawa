...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    */
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(bnAvg, nLastBlockTime, nFirstBlockTime, chainParams->GetConsensus()), 0x1d00ffffU); // Sugarchain: DAA SugarShield-N510 // fix after YespowerSugar
}
