...
BOOST_AUTO_TEST_CASE(get_next_work)
{
    ...
    */
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(bnAvg, nLastBlockTime, nFirstBlockTime, chainParams->GetConsensus()), 0x1f17a045U); // Sugarchain: Introduce YespowerSugar // 521642053
}
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit)
{
    ...
    */
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(bnAvg, nLastBlockTime, nFirstBlockTime, chainParams->GetConsensus()), 0x1f35c28eU); // Sugarchain: Introduce YespowerSugar // 523616910
}
...
BOOST_AUTO_TEST_CASE(get_next_work_lower_limit_actual)
{
    ...
    */
    ...
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(bnAvg, nLastBlockTime, nFirstBlockTime, chainParams->GetConsensus()), 0x1f2ef45cU); // Sugarchain: Introduce YespowerSugar // 523170908
}
...
BOOST_AUTO_TEST_CASE(get_next_work_upper_limit_actual)
{
    ...
    */
    ...
    int64_t nLastBlockTime = 1555910839;
    int64_t nFirstBlockTime = 1555908929;
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(bnAvg, nLastBlockTime, nFirstBlockTime, chainParams->GetConsensus()), 0x1f35c0ddU); // Sugarchain: Introduce YespowerSugar // 523616477
}
