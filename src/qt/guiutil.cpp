...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("bitcoin")) // Sugarchain: Branding // uritests.h(20)
        return false;
...
QString formatBitcoinURI(const SendCoinsRecipient &info)
{
    ...
    QString ret = QString("bitcoin:%1").arg(bech_32 ? info.address.toUpper() : info.address); // Sugarchain: Branding // uritests.h(20)
    int paramCount = 0;
