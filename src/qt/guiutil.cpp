...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(!uri.isValid() || uri.scheme() != QString("bitcoin")) // TODO.ZENY.BRANDING
        return false;
...
QString formatBitcoinURI(const SendCoinsRecipient &info)
{
    ...
    QString ret = QString("bitcoin:%1").arg(bech_32 ? info.address.toUpper() : info.address); // TODO.ZENY.BRANDING
    int paramCount = 0;
