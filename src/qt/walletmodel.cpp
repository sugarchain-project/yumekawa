...
#include <validation.h> // Reduce interval of QT balance refresh // for "::ChainActive().Height()"
...
WalletModel::WalletModel(std::unique_ptr<interfaces::Wallet> wallet, ClientModel& client_model, const PlatformStyle *platformStyle, QObject *parent) :
    ...
    cachedNumBlocks(0), // Reduce interval of QT balance refresh
...
void WalletModel::pollBalanceChanged()
{
    ...
    */
    ...
    if (fForceCheckBalanceChanged || block_hash != m_cached_last_update_tip || ::ChainActive().Height() != cachedNumBlocks) {
        fForceCheckBalanceChanged = false;
