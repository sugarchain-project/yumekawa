...
export RUN_FUZZ_TESTS=false # Sugarchain: Introduce YespowerSugar # TEST DISABLED # Due to timeout...
# export FUZZ_TESTS_CONFIG="--valgrind" # Sugarchain: Introduce YespowerSugar # TEST DISABLED # Due to timeout...
export GOAL="install"
