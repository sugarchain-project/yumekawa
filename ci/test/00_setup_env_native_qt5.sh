...
'
# ENDCOMMENT
export TEST_RUNNER_EXTRA="--coverage --exclude rpc_bind --exclude p2p_blockfilters" # Sugarchain: Introduce YespowerSugar # TEST DISABLED # Due to timeout...
...
# YESPOWER_CFLAGS="CFLAGS='-I$YESPOWER_PATH $YESPOWER_OPTION'" # Sugarchain: Introduce YespowerSugar # Already there a CFLAGS
