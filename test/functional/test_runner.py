...
BASE_SCRIPTS = [
    ...
    # 'feature_backwards_compatibility.py --legacy-wallet', # Sugarchain: Branding
    ...
    # 'wallet_upgradewallet.py --legacy-wallet', # Sugarchain: Branding
    'rpc_bind.py --ipv4',
    'rpc_bind.py --ipv6',
...
def check_script_list(*, src_dir, fail_on_warn):
    ...
    if len(missed_tests) != 0:
        ...
        if fail_on_warn:
            # Sugarchain: Branding # Cirrus CI: bypass fail on warn
            """
