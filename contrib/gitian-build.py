...
def setup():
    ...
    if not os.path.isdir('sugarchain'):
        subprocess.check_call(['git', 'clone', 'https://github.com/sugarchain-project/yumekawa.git'])
...
def main():
    ...
    parser.add_argument('-u', '--url', dest='url', default='https://github.com/sugarchain-project/yumekawa', help='Specify the URL of the repository. Default is %(default)s')
