...
# key types
PUBKEY_ADDRESS = 63             # legacy: starting with "S" (upper)
SCRIPT_ADDRESS = 125            # p2sh-segwit: starting with "s" (lower)
PUBKEY_ADDRESS_TEST = 66        # legacy: starting with "T" (upper)
SCRIPT_ADDRESS_TEST = 128       # p2sh-segwit: starting with "t" (lower)
PUBKEY_ADDRESS_REGTEST = 61     # legacy: starting with "R" (upper)
SCRIPT_ADDRESS_REGTEST = 123    # p2sh-segwit: starting with "r" (lower)
PRIVKEY = 128
PRIVKEY_TEST = 239
PRIVKEY_REGTEST = 239
...
bech32_templates = [
  ...
  ('sugar',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('sugar',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('sugar',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tugar',    0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tugar',    0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tugar',    2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rugar',    0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rugar',    0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rugar',   16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tsgar',    0, 20, False, False, False),
  ('tugar',   17, 32, False, False, False),
  ('rugar',    3,  1, False, False, False),
  ('sugar',   15, 41, False, False, False),
  ('tugar',    0, 16, False, False, False),
  ('rugar',    0, 32, True,  False, False),
  ('sugar',    0, 16, True,  False, False),
  ('tugar',    0, 32, False, True,  False),
  ('rugar',    0, 20, False, False, True)
]
